...
var checkboxMaisculas = document.querySelector(".chx-maiusculas");
var checkboxMinusculas = document.querySelector(".chx-minusculas");
var checkboxNumeros = document.querySelector(".chx-numeros");
var checkboxSimbolos = document.querySelector(".chx-simbolos");
...
function gera() {
  var senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdCaracteres.value, checkboxMaisculas.checked, checkboxMinusculas.checked, checkboxNumeros.checked, checkboxSimbolos.checked);
  return senha;
}
